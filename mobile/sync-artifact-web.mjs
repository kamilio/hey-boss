...
for(const name of ['artifacts.html','artifact-editor.js','artifact-diagrams.js','artifacts.js','artifacts.css','attachments.js','attachments.css','status.js','status.css','routes.js','components.js','components.css','app.css','icon.png']){
 ...
 if(name==='artifacts.html'){
  ...
  html=html.replace('<html lang="en">','<html lang="en" data-artifact-mobile="true">').replace(/(?:<script src="\/quick-issue.js" defer><\/script>)/g,'').replace(/(src|href)="\/(icon.png|routes.js|components.js|components.css|app.css|artifacts.js|artifacts.css|attachments.js|attachments.css|status.js|status.css)"/g,'$1="/artifact-web/$2"');
