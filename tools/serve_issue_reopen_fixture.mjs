...
const root = realpathSync(mkdtempSync(join(tmpdir(), 'hey-boss-issue361-')));
...
try {
  ...
  start(['issue','--project','Reopen QA','web','--port','59661','--no-discovery','--json']);
  const native='http://127.0.0.1:59661', paired='http://127.0.0.1:52061';
  let boot;
  ...
  server=app.listen(52061,'127.0.0.1');
